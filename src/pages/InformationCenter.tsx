  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Information Center for Pilipinas Rotaract Multi-District Information Organization" 
        />
      </Helmet>
      ...
      <main>
        ...
        <section className="relative h-96 flex items-end">
          ...
          <div className="relative w-full mx-auto px-auto sm:px-6 lg:px-8 py-8 text-white">
            <h1 className="text-4xl sm:text-5xl font-bold text-start text-white">

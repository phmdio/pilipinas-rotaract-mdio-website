...
const FeatureCard = ({
  ...
  description = '',
  summary = 'Hipster ipsum tattooed brunch I\'m baby. Schlitz seitan listicle mixtape boys trust vice. Occupy tbh street brunch keffiyeh. Bicycle diy blog banjo fingerstache tote on locavore coffee pabst.',

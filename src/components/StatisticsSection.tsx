...
const StatisticsSection = () => {
  ...
  return (
    <section id="statistics" className="relative py-16 px-4 sm:px-6 lg:px-8 bg-rotaract-magenta text-white overflow-hidden">
      ...
      {/* Wave bottom divider and foundation section */}
      <div className="mt-16 relative">
        ...
        {/* Foundation section starts after the wave */}
        <div className="bg-[#1a1a1a] pt-20 pb-12 px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-7xl mx-auto">
            <div className={cn(
              "text-center mb-8 transition-all duration-500 opacity-0 translate-y-4",
              inView && "opacity-100 translate-y-0"
            )}>
              <h2 className="text-2xl font-bold text-white mb-4">The Rotary Foundation Giving</h2>
              <p className="text-white/80 max-w-3xl mx-auto">
                Support our global initiatives through contributions to The Rotary Foundation.
              </p>
              <button className="mt-6 bg-rotaract-gold text-gray-900 px-6 py-3 rounded-md font-medium transition-all hover:bg-opacity-90">
                Donate Now
              </button>
            </div>
          </div>
